...
from type_results.handlers.results_handlers import CurrentUserResults, AllUserResults
from type_results.structs import UserTypingResultWithUser, UserTypingResult
